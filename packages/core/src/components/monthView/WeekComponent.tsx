...
interface WeekComponentProps {
  ...
  onCalendarDrop?: (e: any, dropDate: Date, dropHour?: number, isAllDay?: boolean) => Event | null;
  onCalendarDragOver?: (e: any) => void;
...
(WeekComponent as any).displayName = 'WeekComponent';
