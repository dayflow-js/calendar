...
| `gridDateDoubleClick` | `'day-view' \| 'none' \| function` | `'day-view'` | Action when a date cell is double-clicked.                    |
| `hourHeight`          | `number`                           | `72`         | Height in pixels of each hour row in the time grid.           |
...
| `gridDateDoubleClick` | `'week-view' \| 'day-view' \| 'none' \| function` | `'week-view'` | Action when a date cell is double-clicked.                                                      |
