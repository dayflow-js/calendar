...
If your application manages event detail in its own modals (driven by callbacks or global state), you can suppress the built-in floating panel entirely without providing a replacement:
