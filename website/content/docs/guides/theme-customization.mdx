...
DayFlow's components use Tailwind utility classes (`flex`, `bg-white`, `text-gray-600`, etc.) internally. Your project's Tailwind instance must generate those classes by scanning DayFlow's source files.
