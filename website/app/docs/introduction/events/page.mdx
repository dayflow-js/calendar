...
| `icon`        | `boolean \| ReactNode`                                                   | Custom icon for the event. `true` (default): show default, `false`: hide, `ReactNode`: custom icon                | ❌ No    |
...
- [Plugins](/docs/introduction/plugins) - Event management with plugins
- [Getting Started](/docs/introduction/getting-started) - Basic usage examples
