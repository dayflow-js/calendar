...
| `className`                | `string`                     | ❌        | Additional class names appended to the root container (base class: `df-calendar-container`).        |
...
| `search`                   | `CalendarSearchProps`        | ❌        | Configuration for the built-in search functionality.                                                |
