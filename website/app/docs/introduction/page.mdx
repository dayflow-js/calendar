export const metadata = {
  ...
  description:
    'Learn how to install and integrate DayFlow into your React, Vue, Svelte, or Angular application. Quick start guide for the universal calendar component.',
  openGraph: {
    title: 'Getting Started with DayFlow',
    description:
      'Quick start guide: Install and configure DayFlow for React, Vue, Svelte, and Angular.',
  },
};
