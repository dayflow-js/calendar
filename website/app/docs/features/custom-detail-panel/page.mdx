...
- `customDetailPanelContent` receives a component from your native framework that only renders the inner content—the wrapper and positioning remain managed by the library.
